...
public class VuforiaTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //get camera
        webcamName = hardwareMap.get(WebcamName.class, Config.WEBCAM);
